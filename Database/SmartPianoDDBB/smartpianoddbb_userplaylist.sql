...
CREATE TABLE `userplaylist` (
  ...
  CONSTRAINT `userplaylist_ibfk_1` FOREIGN KEY (`username`) REFERENCES `user` (`username`),
  CONSTRAINT `userplaylist_ibfk_2` FOREIGN KEY (`ID_playlist`) REFERENCES `playlist` (`id`)
...
INSERT INTO `userplaylist` VALUES ('admin',1),('admin',2),('admin',3);
