...
public class DeleteSongPanel extends JPanel {
    ...
    private JPanel deleteSongPopUpPanel;
    private JDialog deleteSongPopUpDialog;
    ...
    public DeleteSongPanel (){
        iiPopUpSuccessful = new ImageIcon("src/Icons/Playlist Library Screen/Grupo 265.png");
        ...
        jbyes.setActionCommand(ConstantList.DELETE_SONG_YES);
        ...
        jbno.setActionCommand(ConstantList.DELETE_SONG_NO);
        ...
        deleteSongPopUpPanel = new JPanel();
        deleteSongPopUpPanel.setLayout(new BoxLayout(deleteSongPopUpPanel, BoxLayout.Y_AXIS));
        deleteSongPopUpPanel.setBackground(Color.WHITE);
        deleteSongPopUpPanel.add(jlPopUpSuccessful);
        deleteSongPopUpPanel.add(buttonpanels);
        deleteSongPopUpPanel.setFocusable(true);
        deleteSongPopUpPanel.requestFocusInWindow();
        deleteSongPopUpPanel.setBorder(BorderFactory.createLineBorder(Color.DARK_GRAY, 2));
    }
    ...
    public void sucessfulRefreshedPopUpShow(){
        deleteSongPopUpDialog = new JDialog();
        deleteSongPopUpDialog.setUndecorated(true);
        deleteSongPopUpDialog.add(deleteSongPopUpPanel);
        deleteSongPopUpDialog.pack();
        deleteSongPopUpDialog.setLocationRelativeTo(null);
        deleteSongPopUpDialog.setVisible(true);
    }
