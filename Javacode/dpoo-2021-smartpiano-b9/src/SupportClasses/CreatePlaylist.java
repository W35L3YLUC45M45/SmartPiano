...
public class CreatePlaylist extends JPanel {
    ...
    /**
     * Class created specifically for the 'create playlist'
     * panel with the objective of creating new playlists
    ...
    public CreatePlaylist(){
        ...
        iiSaveArrHeader = new ImageIcon("src/Icons/Playlist Library Screen/Grupo 267.png");
        ...
        jbSave.setActionCommand(ConstantList.CREATE_PLAYLIST_YES);
        jbCancel.setActionCommand(ConstantList.CREATE_PLAYLIST_NO);
     ...
     */
    public void createPlaylistPopUpShow(){
